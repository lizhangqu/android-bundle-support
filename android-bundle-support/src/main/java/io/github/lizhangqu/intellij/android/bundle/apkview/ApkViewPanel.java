...
public class ApkViewPanel implements TreeSelectionListener {
    ...
    public ApkViewPanel(@NotNull Project project, @NotNull ApkParser apkParser) {
        ...
        ListenableFuture<ArchiveNode> archiveNodeListenableFuture = apkParser.constructTreeStructure();
        archiveNodeListenableFuture.addListener(new CallbackListener<>(archiveNodeListenableFuture, new FutureCallBackAdapter<ArchiveNode>() {
            @Override
        ...
        ListenableFuture<ArchiveNode> archiveNodeListenableFuture1 = apkParser.updateTreeWithDownloadSizes();
        archiveNodeListenableFuture1.addListener(new CallbackListener<>(archiveNodeListenableFuture1, new FutureCallBackAdapter<ArchiveNode>() {
            @Override
            public void onSuccess(ArchiveNode result) {
                if (myArchiveDisposed) {
                    return;
        ...
        applicationInfo.addListener(new CallbackListener<>(applicationInfo, new FutureCallBackAdapter<AndroidApplicationInfo>() {
            @Override
        ...
        ListenableFuture<List<Long>> listListenableFuture = Futures.successfulAsList(uncompressedApkSize, compressedFullApkSize);
        listListenableFuture.addListener(new CallbackListener<>(listListenableFuture, new FutureCallBackAdapter<List<Long>>() {
            @Override
        ...
        ListenableFuture<List<Object>> listListenableFuture1 = Futures.allAsList(uncompressedApkSize, compressedFullApkSize, applicationInfo);
        listListenableFuture1.addListener(new CallbackListener<>(listListenableFuture1, new FutureCallBackAdapter<List<Object>>() {
            @Override
    ...
    public static final class CallbackListener<V> implements Runnable {
        ...
        public void run() {
            ...
            this.callback.onSuccess((V) value);
        }
